const ClassCard2 = ({ classInfo }) => {
  ...
  return (
    <div className="bg-gray-200 shadow-xl rounded">
      <img
        className="w-full h-64 md:h-60 lg:h-56 2xl:h-64 rounded object-cover"
        src={imgUrl}
        alt=""
      />
      <div className="bg-white p-6 text-center border-b-4 border-blue-500 dark:border-blue-800">
